...
?>
<script>window.watcher = true;</script>
<nav class="navbar">
	...
	<div class="navbar__collapse">
		...
		<a href="<?= __ROOT__ ?>/watcher/quincho" class="navbar__item">Quincho</a>
		<a href="<?= __ROOT__ ?>/watcher/propiedades" class="navbar__item">Residentes Temporarios</a>
